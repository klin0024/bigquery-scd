CREATE TABLE `cloud-tech-se-sandbox.allen_dataset.employees` 
(emp_no INTEGER, birth_date DATE, first_name STRING, last_name STRING, gender STRING, hire_date DATE);


INSERT INTO `cloud-tech-se-sandbox.allen_dataset.employees` VALUES 
